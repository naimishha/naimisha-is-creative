...
public class LabManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void approvalJButtonActionPerformed(java.awt.event.ActionEvent evt) {                                               
    int selectedRow = workRequestJTable.getSelectedRow();

    if (selectedRow < 0) {
        JOptionPane.showMessageDialog(this, "Please select a row to process", "Warning", JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    if (request.getStatus().equals("Completed")) {
        JOptionPane.showMessageDialog(this, "Request is already completed", "Warning", JOptionPane.WARNING_MESSAGE);
        return;
    }

    request.setStatus("Processing");

    // Instantiate ProcessWorkRequestJPanel with required parameters
    Component processWorkRequestJPanel = new LabManagerWorkAreaJPanel(userProcessContainer, userAccount, business, business);
